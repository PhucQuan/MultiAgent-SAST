...
function FilterSelect({
  ...
  return (
    <Select value={value} onValueChange={onChange}>
      <SelectTrigger className="h-8 w-[130px] rounded-sm border-border bg-surface text-[12.5px]">
    ...
    >
      ...
      <td className="hidden px-3 py-2.5 lg:table-cell">
        ...
        <div className="num mt-1 text-[11.5px] text-muted-foreground">
          {formatLabel(finding.language)} | {formatConfidence(finding.confidence)} |{" "}
          {finding.id}
        </div>
      </td>
      <td className="w-[190px] px-3 py-2.5">
        ...
        {feedback?.disposition ? (
          <div className="mt-1 text-[11.5px] font-medium text-primary">
            Reviewer override: {dispositionLabels[feedback.disposition]}
          </div>
        ) : null}
      </td>
    </tr>
